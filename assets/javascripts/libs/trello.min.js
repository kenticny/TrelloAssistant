(function(){
var opts={"version":1,"apiEndpoint":"https://api.trello.com","authEndpoint":"https://trello.com","key":"1f7fc3749300a14a879de2eef7fba060"};
...
null==e&&(e=null!=(h=a.exec(n.hash))?h[1]:void 0);if(this.authorized())return d(),n.hash=n.hash.replace(a,""),"function"===typeof b.success?b.success():void 0;if(!b.interactive)return"function"===typeof b.error?b.error():void 0;k=function(){var a,c;a=b.scope;c=[];for(q in a)(f=a[q])&&c.push(q);return c}().join(",");switch(b.type){case "popup":(function(){var a,q,e,f;waitUntil("authorized",function(a){return function(a){return a?(d(),"function"===typeof b.success?b.success():void 0):"function"===typeof b.error?
b.error():void 0}}(this));a=c.screenX+(c.innerWidth-420)/2;e=c.screenY+(c.innerHeight-470)/2;q=null!=(f=/^[a-z]+:\/\/[^\/]*/.exec(n))?f[0]:void 0;return c.open(w({return_url:q,callback_method:"postMessage",scope:k,expiration:b.expiration,name:b.name}),"trello","width=420,height=470,left="+a+",top="+e)})();break;default:c.location=w({redirect_uri:n.href,callback_method:"fragment",scope:k,expiration:b.expiration,name:b.name})}}};p=["GET","PUT","POST","DELETE"];u=function(a){return f[a.toLowerCase()]=
